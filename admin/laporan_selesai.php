  ...
  <main class="admin-content">
    ...
    <div class="card">
      <div class="card-header">
        <h3><i class="ri-checkbox-circle-line"></i> Daftar Laporan Terselesaikan</h3>
      </div>
      <div class="card-body">
            ...
            <tbody>
              ...
              <tr>
                <td colspan="9" style="text-align: center; padding: 60px;">
                  <i class="ri-checkbox-circle-line" style="font-size: 64px; color: #e5e7eb; display: block; margin-bottom: 16px;"></i>
                  <p style="color: #9ca3af; font-size: 16px;">Belum ada laporan selesai</p>
                </td>
              </tr>
              <?php else: ?>
                ...
                <tr>
                  ...
                  <td><?php echo htmlspecialchars(substr($report['lokasi'], 0, 40)); ?><?php echo strlen($report['lokasi']) > 40 ? '...' : ''; ?></td>
                  <td><?php echo date('d M Y', strtotime($report['tanggal_lapor'])); ?></td>
                  <td><?php echo date('d M Y', strtotime($report['tanggal_selesai'])); ?></td>
                  <td>
                    <span class="badge badge-success"><?php echo $duration; ?> hari</span>
                  </td>
                  <td><?php echo $report['biaya'] ? 'Rp ' . number_format($report['biaya'], 0, ',', '.') : '-'; ?></td>
                  <td>
